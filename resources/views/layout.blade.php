...
<body>
  ...
  <div class="header">
    <div class="container">
      <h1 class="logo"><a href="https://bitcointhefts.com/">Bitcoin Thefts</a></h1>
      <nav class="nav-collapse">
        <ul class="noList">
	  <li class="element first"><a href="/">Home</a></li>
          <li><a href="/submit">Submit</a></li>
          <li><a href="http://blog.techendeavors.com/tagged/bitcointhefts">Blog</a></li>
		...
		Powered by <a href="http://laravel.com">Laravel <?php $laravel = app(); echo $laravel::VERSION; ?></a>. Laravel is a trademark of Taylor Otwell. 
	      ...
	      <div class="footer-links">
	         <ul class="noList">
	            ...
	            <li><a href="https://github.com/deftnerd/bitcointhefts">
	            ...
	            <li><a href="mailto:hello@bitcointhefts.com">
